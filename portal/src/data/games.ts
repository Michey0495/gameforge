...
export const GAMES: GameInfo[] = [
  ...
  {
    id: 'lifegame',
    folderName: '12-lifegame',
    name: 'ライフゲーム',
    subtitle: 'コンウェイの生命シミュレーション',
    description:
      'セルが2〜3個の隣人で生き延び、3個ぴったりで誕生する古典シミュレーション。グライダーやガンなど代表パターンをプリセットから呼び出せる。クリックで自由に描画。',
    category: 'puzzle',
    controls: ['クリック/ドラッグ : セル描画', 'Space : 再生/停止', 'R : ランダム', 'C : クリア'],
    features: [
      '80x50グリッド',
      'トーラス境界',
      '速度1〜60fps可変',
    ...
    hasSound: false,
    difficulty: 'easy',
    thumbnail: '/screenshots/lifegame.svg',
  },
  {
    id: 'typing',
    folderName: '13-typing',
    name: 'タイピング速度計測',
    subtitle: 'WPMと正確率を即時計測',
    description:
      '提示された英文を打ち込んでWPM(Words Per Minute)と正確率を計測。英語/コード/名言の3カテゴリ。直近10回の履歴から最高と平均を表示。アイスブレイクで盛り上がる定番。',
    category: 'arcade',
    controls: ['英字キー : 入力', 'Tab : リスタート'],
    features: [
      'WPM/正確率/経過秒のリアルタイム表示',
      '文字単位の正誤ハイライト',
      '英語・コード・名言の3カテゴリ',
      '履歴10件と最高/平均をlocalStorage保存',
    ],
    hasSound: false,
    difficulty: 'easy',
    thumbnail: '/screenshots/typing.svg',
  },
  {
    id: 'omikuji',
    folderName: '14-omikuji',
    name: 'おみくじ診断',
    subtitle: '今日の運勢を引く',
    description:
      '箱をタップして引く和風おみくじ。大吉から凶まで重み付き抽選、恋愛/仕事/金運/健康/ラッキーアイテムの5項目アドバイス付き。アイスブレイクの会話のきっかけに。',
    category: 'puzzle',
    controls: ['クリック : おみくじを引く'],
    features: [
      '6段階の運勢（重み付き抽選）',
      '5項目の個別アドバイス',
      '運勢ごとのアドバイス文ランダム',
    ...
    hasSound: false,
    difficulty: 'easy',
    thumbnail: '/screenshots/omikuji.svg',
  },
]
